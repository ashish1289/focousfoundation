    ...
    <section className="w-full relative pb-32 overflow-hidden selection:bg-[#C9A84C] selection:text-white" style={{ background: "linear-gradient(to bottom right, #FDF8F0, #F5EDD8, #EDE4CE)" }}>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10 mb-32 relative z-10">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative rounded-[2rem] p-8 md:p-12 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10 md:gap-6 overflow-hidden"
          style={{ background: "#FFFFFF", border: "1px solid #EDE4CE" }}
        >
          {/* Top accent line */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, idx) => (
            <motion.div
              ...
              className="relative bg-white p-8 rounded-[2rem] shadow-lg border border-[#EDE4CE] text-center group transition-all duration-300 overflow-hidden"
            >
              {/* Bottom sweep line */}
